...
const typeSpecs = [
    ...
    new TypeSpec(new TypeID("AWS", "AppSync", "DataSource"), { namePropIncludesTypeName: false, nameConverter: ({ value }) => value.replace(/-/g, "_") }),
    new TypeSpec(new TypeID("AWS", "AppSync", "FunctionConfiguration"), { namePropIncludesTypeName: false, nameConverter: ({ value }) => value.replace(/-/g, "_") }),
            ...
            this.hooks = {
                ...
                "before:deploy:function:initialize": () => {
                    Object.keys(this.service.functions).forEach((key) => {
                        ...
                        func.name = spec.getNameValue({ logicalElement: {}, element: {}, logicalName: key + "LambdaFunction", pluginConfig: this.config });
                    });
