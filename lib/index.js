...
const customTypeBehaviours = [
    ...
    new TypeSpec(new TypeID("AWS", "Amplify", "Branch")),
    new TypeSpec(new TypeID("AWS", "Amplify", "Domain")),
    ...
    new TypeSpec(new TypeID("AWS", "ApiGateway", "RequestValidator"), { noNameInsertion: true }),
    ...
    new TypeSpec(new TypeID("AWS", "ApiGateway", "UsagePlan"), { noNameInsertion: true }),
...
class ServerlessAwsAutoResourceNamesPlugin {
    ...
    applyOnResource(resources, logicalName){
        ...
        const instanceTypeSpecifications = customTypeBehaviours.concat(new TypeSpec(new TypeID("AWS", typeProvider, typeName)));
