...
class TypeBehaviourSpecification {
     ...
     */
    getNameProp(){
        return this.namePropReplacement || (this.namePropIncludesTypeName ? this.typeName + "Name" : "Name");
    }
...
const customTypeBehaviours = [
    ...
    new TypeBehaviourSpecification("AppSync", "GraphQLApi", { namePropIncludesTypeName: false }),
    new TypeBehaviourSpecification("AppSync", "DataSource", { namePropIncludesTypeName: false }),
    new TypeBehaviourSpecification("AppSync", "FunctionConfiguration", { namePropIncludesTypeName: false }),
    new TypeBehaviourSpecification("AppSync", "GraphQLSchema", { namePropIncludesTypeName: false }),

    new TypeBehaviourSpecification("Lambda", "Version", { noNameInsertion: true }),
    new TypeBehaviourSpecification("AppSync", "ApiKey", { noNameInsertion: true }),
    new TypeBehaviourSpecification("AppSync", "Resolver", { noNameInsertion: true }),

    new TypeBehaviourSpecification("Cognito", "UserPoolClient", { namePropReplacement: "ClientName" }),
